...
import com.shashilabs.bookmarker.domain.Bookmark;
import com.shashilabs.bookmarker.domain.BookmarkRepository;
...
public class BookmarkControllerTest {
    ...
    void setUp() {
        ...
        bookmarks.add(new Bookmark(null, "shashilabs", "https://shashilabs.in", Instant.now()));
    ...
    void shouldCreateBookmarkSuccessfully() throws Exception {
        this.mvc.perform(
                        post("/api/bookmarks")
                                ...
                                .content("""
            {
                "title": "shashilabs Blog",
                "url": "https://shashilabs.in"
            }
            """)
                )
                .andExpect(status().isCreated())
                .andExpect(jsonPath("$.id", notNullValue()))
                .andExpect(jsonPath("$.title", is("shashilabs Blog")))
                .andExpect(jsonPath("$.url", is("https://shashilabs.in")));
    }
